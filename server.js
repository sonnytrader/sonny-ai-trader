...
const CFG = {
    ...
    SCAN_MS: 60000,
    LIVE_MS: 10000,
    CONCURRENCY: 4, // 6'dan 4'e düşürüldü
...
const STATE = {
    ...
    signalHistory: [] // Basit geçmiş kaydı (memory)
};
...
async function getTickers() {
    ...
    try {
        ...
        console.error('Tickers alınamadı, son bilinen liste kullanılıyor:', error.message);
        return STATE.universe; // Son başarılı liste
    }
...
async function runScan() {
    ...
    try {
        ...
        // BTC ve ETH trendlerini hesapla
        ...
        for (let i = 0; i < deep.length; i += CFG.CONCURRENCY) {
            ...
            await sleep(100); // Rate limit için küçük gecikme
        }
...
// ========================= FRONTEND (hacim paneli eklenmiş) =========================
...
var volumeHeight=50; // Alt kısım hacim için
...
setInterval(loadChart,5000); // 5 saniyede bir grafik güncelle
})();
</script>
</body>
</html>`;
